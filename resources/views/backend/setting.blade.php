            ...
            <div class="input-group">
                <div class="input-group-btn">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#"onclick="event.preventDefault().getElementById('setwebhook').submit();">Отправить Url</a></li>
                        <li><a href="#"onclick="event.preventDefault().getElementById('getwebhookinfo').submit();">Получить информацию</a></li>
                    </ul>
                </div>
...
<form id="setwebhookinfo" action="{{ route('admin.setting.getwebhookinfo') }}" method="POST" style="display: none;">
    {{ csrf_field() }}
</form>
